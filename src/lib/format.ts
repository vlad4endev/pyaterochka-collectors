...
const ERROR_RU: Record<string, string> = {
  ...
  "Entry is pending review": "Сначала разберите накладную на проверке",
  ...
  "Invalid MAX bot token": "Неверный токен MAX-бота — проверьте у Master Bot",
  ...
  "Group chat is not linked": "Сначала привяжите группу в разделе Telegram или MAX",
  "MAX group chat is not linked": "Сначала привяжите группу в разделе MAX",
  "Failed to send Telegram message": "Не удалось отправить сообщение в Telegram",
  "Failed to send MAX message": "Не удалось отправить сообщение в MAX",
  ...
  "Collector has no messenger ID": "У участника нет Telegram ID и MAX ID — укажите в разделе Участники",
  "Collector has not started the bot": "Участник ещё не нажал /start у бота — бот не может написать первым",
  "Collector has not started the MAX bot": "Участник ещё не открыл MAX-бота — бот не может написать первым",
  ...
  "Invalid MAX initData": "Открой приложение из MAX-бота",
  "MAX initData expired": "Сессия MAX истекла — закрой и открой приложение снова",
